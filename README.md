...
- 🌡️ **Live temperature** — displayed in °C
...
- [SheCodes Weather API](https://apis.shecodes.io/weather/docs) — weather data provider
...
- Weather data provided by [SheCodes Weather API](https://apis.shecodes.io/weather/docs)
- Built as part of the [SheCodes](https://www.shecodes.io/) coding program
